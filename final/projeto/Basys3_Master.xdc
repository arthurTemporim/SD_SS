...
set_property PACKAGE_PIN W17 [get_ports {k[3]}];		
...
set_property PACKAGE_PIN T2 [get_ports hab_clk]				
...
##Buttons
#set_property PACKAGE_PIN U18 [get_ports hab_clk]					set_property IOSTANDARD LVCMOS33 [get_ports hab_clk]
#set_property PACKAGE_PIN T18 [get_ports but_clk]				
#	set_property IOSTANDARD LVCMOS33 [get_ports but_clk]
#set_property PACKAGE_PIN W19 [get_ports btnL]						#set_property IOSTANDARD LVCMOS33 [get_ports btnL]
